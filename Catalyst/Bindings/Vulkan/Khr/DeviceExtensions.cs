...
namespace Vulkan.Khr
{
    ...
    public struct BufferMemoryRequirementsInfo2Khr
    {
        ...
        public IntPtr Next;
        /// <summary>
        /// The <see cref="Vulkan.Buffer"/> to query.
        /// </summary>
        public long Buffer;
    }
    ...
    public struct ImageMemoryRequirementsInfo2Khr
    {
        ...
        public IntPtr Next;
        /// <summary>
        /// The <see cref="Vulkan.Image"/> to query.
        /// </summary>
        public long Image;
    }
    ...
    public struct BindBufferMemoryInfoKhr
    {
        ...
        public IntPtr Next;
        /// <summary>
        /// The <see cref="Vulkan.Buffer"/> to be attached to memory.
        /// </summary>
        public long Buffer;
        /// <summary>
        ...
        /// </summary>
        /// <param name="buffer">The <see cref="Vulkan.Buffer"/> to be attached to memory.</param>
        /// <param name="memory">
        /// A <see cref="DeviceMemory"/> object describing the device memory to attach.
        /// </param>
    ...
    public struct BindImageMemoryInfoKhr
    {
        ...
        public IntPtr Next;
        /// <summary>
        /// The <see cref="Vulkan.Image"/> to be attached to memory.
        /// </summary>
        public long Image;
        /// <summary>
        /// A <see cref="DeviceMemory"/> object describing the device memory to attach.
        ...
        /// </summary>
        /// <param name="image">The <see cref="Vulkan.Image"/> to be attached to memory.</param>
        /// <param name="memory">
        /// A <see cref="DeviceMemory"/> object describing the device memory to attach.
        /// </param>
        /// <param name="memoryOffset">
