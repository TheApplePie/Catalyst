...
namespace Vulkan.NV
{
    ...
    public struct DedicatedAllocationMemoryAllocateInfoNV
    {
        ...
        public IntPtr Next;
        /// <summary>
        /// Is <c>0</c> or a handle of an <see cref="Vulkan.Image"/> which this memory will be
        /// bound to.
        /// </summary>
        public long Image;
        /// <summary>
        /// Is <c>0</c> or a handle of a <see cref="Vulkan.Buffer"/> which this memory will be
        /// bound to.
        /// </summary>
        public long Buffer;
        ...
        /// </summary>
        /// <param name="image">
        /// Is <c>null</c> or an <see cref="Vulkan.Image"/> which this memory will be bound to.
        /// </param>
        /// <param name="next">
        /// Is <see cref="IntPtr.Zero"/> or a pointer to an extension-specific structure.
        /// </param>
