...
namespace Vulkan.Nvx
{
    ...
    public struct ObjectTablePipelineEntryNvx
    {
        ...
        public ObjectEntryUsagesNvx Flags;
        /// <summary>
        /// Specifies the <see cref="Vulkan.Pipeline"/> that this resource entry references.
        /// </summary>
    ...
    public struct ObjectTableDescriptorSetEntryNvx
    {
        ...
        public ObjectEntryUsagesNvx Flags;
        /// <summary>
        /// Specifies the <see cref="Vulkan.PipelineLayout"/> that the <see
        /// cref="DescriptorSet"/> is used with.
        /// </summary>
        public long PipelineLayout;
        /// <summary>
        /// Specifies the <see cref="Vulkan.DescriptorSet"/> that can be bound with this entry.
        /// </summary>
    ...
    public struct ObjectTableVertexBufferEntryNvx
    {
        ...
        public ObjectEntryUsagesNvx Flags;
        /// <summary>
        /// Specifies the <see cref="Vulkan.Buffer"/> that can be bound as vertex buffer.
        /// </summary>
        public long Buffer;
    }
    ...
    public struct ObjectTableIndexBufferEntryNvx
    {
        ...
        public ObjectEntryUsagesNvx Flags;
        /// <summary>
        /// Specifies the <see cref="Vulkan.Buffer"/> that can be bound as index buffer.
        /// </summary>
        public long Buffer;
        /// <summary>
        /// Specifies the <see cref="Vulkan.IndexType"/> used with this index buffer.
        /// </summary>
    ...
    public struct ObjectTablePushConstantEntryNvx
    {
        ...
        public ObjectEntryUsagesNvx Flags;
        /// <summary>
        /// Specifies the <see cref="Vulkan.PipelineLayout"/> that push constants using this object index are used with.
        /// </summary>
        public long PipelineLayout;
        /// <summary>
