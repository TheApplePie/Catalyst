...
namespace Vulkan
{
    ...
    public struct CommandBufferInheritanceInfo
    {
        ...
        /// <summary>
        /// A <see cref="Vulkan.RenderPass"/> object defining which render passes the <see
        ...
        public int Subpass;
        /// <summary>
        /// Optionally refers to the <see cref="Vulkan.Framebuffer"/> object that the <see
    ...
    public struct BufferMemoryBarrier
    {
        ...
        /// <summary>
        /// A <see cref="Vulkan.Buffer"/> handle to the buffer whose backing memory is affected by the barrier.
        /// </summary>
        public long Buffer;
        /// <summary>
        ...
        /// </summary>
        /// <param name="buffer">
        /// A <see cref="Vulkan.Buffer"/> handle to the buffer whose backing memory is affected
        /// by the barrier.
        /// </param>
        /// <param name="srcAccessMask">Specifies a source access mask.</param>
        /// <param name="dstAccessMask">Specifies a destination access mask.</param>
    ...
    public struct ImageMemoryBarrier
    {
        ...
        public int DstQueueFamilyIndex;
        /// <summary>
        /// A handle to the <see cref="Vulkan.Image"/> affected by this barrier.
        /// </summary>
        public long Image;
        /// <summary>
    ...
    {
        /// <summary>
        /// The <see cref="Vulkan.RenderPass"/> to begin an instance of.
        /// </summary>
        public long RenderPass;
        /// <summary>
        /// The <see cref="Vulkan.Framebuffer"/> containing the attachments that are used with
        /// the render pass.
        /// </summary>
        public long Framebuffer;
        /// <summary>
        ...
        /// the render pass.
        /// </param>
        /// <param name="renderPass">The <see cref="Vulkan.RenderPass"/> to use.</param>
        /// <param name="renderArea">The render area that is affected by the render pass instance.</param>
        /// <param name="clearValues">
        /// An array of <see cref="ClearValue"/> structures that contains clear values for each
        /// attachment, if the attachment uses a <see cref="AttachmentDescription.LoadOp"/> value of
