...
namespace Vulkan
{
    ...
    {
        /// <summary>
        /// The <see cref="Vulkan.Buffer"/> object to be bound.
        /// </summary>
        public long Buffer;
        /// <summary>
        ...
        /// </summary>
        /// <param name="buffer">The <see cref="Vulkan.Buffer"/> object to be bound.</param>
    ...
    {
        /// <summary>
        /// The <see cref="Vulkan.Image"/> object to be bound.
        /// </summary>
        public long Image;
        /// <summary>
        /// An array of <see cref="SparseMemoryBind"/> structures.
        ...
        /// </summary>
        /// <param name="image">The <see cref="Vulkan.Image"/> object to be bound.</param>
        /// <param name="binds">An array of <see cref="SparseMemoryBind"/> structures.</param>
