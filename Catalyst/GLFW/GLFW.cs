...
namespace Catalyst.GLFW
{
    ...
    public static class GLFW
    {
        ...
        public static ErrorCode GetError(out string description)
        {
            ...
            description = code == ErrorCode.None ? null : Util.IntPtrToStringUTF8(ptr);
            return code;
        }
        ...
        public static string GetJoystickGuid(int joystickId)
        {
            ...
            return ptr == IntPtr.Zero ? null : Util.IntPtrToStringUTF8(ptr);
        }
        ...
        ///     The version string.
        /// </value>
        public static string VersionString => Util.IntPtrToStringUTF8(GetVersionString());
        ...
        {
            return Util.IntPtrToStringUTF8(GetClipboardStringInternal(window));
        }
        ...
        {
            return Util.IntPtrToStringUTF8(GetJoystickNameInternal(joystick));
        }
        ...
        {
            return Util.IntPtrToStringUTF8(GetKeyNameInternal(key, scanCode));
        }
        ...
        {
            return Util.IntPtrToStringUTF8(GetMonitorNameInternal(monitor));
        }
        ...
        {
            throw new Exception(Util.IntPtrToStringUTF8(message));
        }
