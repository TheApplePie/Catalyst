...
namespace Catalyst.Vulkan.Khr
{
    ...
    public unsafe class SwapchainKhr : DisposableHandle<long>
    {
        ...
        /// is acquired from the presentation Catalyst. Other values for timeout will cause the
        ...
        /// <para>
        /// * <see cref="Result.Success"/> - Indicates the presentation Catalyst. is presenting the
        ...
        ///   properties exactly, but the presentation Catalyst. is presenting the contents of the
    ...
    public struct SwapchainCreateInfoKhr
    {
        ...
        /// <summary>
        /// A value describing the transform, relative to the presentation Catalyst.'s natural
        ...
        /// presentation Catalyst. will transform the image content as part of the presentation operation.
        /// </para>
        /// </summary>
    ...
    /// <summary>
    /// Supported color space of the presentation Catalyst.
    /// </summary>
    ...
    public enum CompositeAlphasKhr
    {
        ...
        PostMultiplied = 1 << 2,
        /// <summary>
        /// The way in which the presentation Catalyst. treats the alpha channel in the images is
    ...
    {
        /// <summary>
        /// Indicates that the presentation Catalyst. does not wait for a vertical blanking period to
        ...
        Immediate = 0,
        /// <summary>
        /// Indicates that the presentation Catalyst. waits for the next vertical blanking period to
        ...
        Fifo = 2,
        /// <summary>
        /// Indicates that the presentation Catalyst. generally waits for the next vertical blanking
        /// period to update the current image. If a vertical blanking period has already passed
        /// since the last update of the current image then the presentation Catalyst. does not wait for
        ...
        FifoRelaxed = 3,
        /// <summary>
        /// Indicates that the presentation Catalyst. and application have concurrent access to a single
        /// image, which is referred to as a shared presentable image. The presentation Catalyst. is
        ...
        /// required. However, the presentation Catalyst. may update the current image at any point,
        /// meaning this mode may result in visible tearing.
        /// </summary>
        SharedDemandRefreshKhr = 1000111000,
        /// <summary>
        /// Indicates that the presentation Catalyst. and application have concurrent access to a single
        /// image, which is referred to as a shared presentable image. The presentation Catalyst.
        ...
        /// Catalyst. must update the current image without any need for further presentation requests.
