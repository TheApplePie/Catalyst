...
namespace Catalyst.Vulkan.Khr
{
    ...
    public struct SurfaceCapabilitiesKhr
    {
        ...
        /// <summary>
        /// Indicates the surface's current transform relative to the presentation Catalyst.'s natural orientation.
        /// </summary>
        ...
        /// supported by the presentation Catalyst. for the surface on the specified device, and at
    ...
    /// the <see cref="ColorSpace"/> determines how the presentation Catalyst. interprets the pixel values.
    /// </para>
    /// </summary>
    [StructLayout(LayoutKind.Sequential)]
