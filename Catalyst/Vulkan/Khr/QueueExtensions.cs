...
namespace Catalyst.Vulkan.Khr
{
    ...
    public struct DisplayPresentInfoKhr
    {
        ...
        /// <summary>
        /// If this is <c>true</c>, the display Catalyst. will enable buffered mode on displays that
        /// support it. This allows the display Catalyst. to stop sending content to the display until a
    ...
    /// </para>
    /// <para>
    /// This is an optimization hint that a presentation Catalyst. may use to only update the region of
    /// a surface that is actually changing. The application still must ensure that all pixels of a
    /// presented image contain the desired values, in case the presentation Catalyst. ignores this hint.
    /// </para>
    /// <para>
