...
namespace Catalyst.Vulkan.Google
{
    /// <summary>
    ...
    public static unsafe class SwapchainKhrExtensions
    {
        ...
        /// </para>
        /// <para>
        /// Because of the asynchronous nature of the presentation Catalyst., the timing information for
    ...
    public struct PresentTimeGoogle
    {
        ...
        /// and Linux). A value of zero indicates that the presentation Catalyst. may display the image
