...
namespace Catalyst.Vulkan
{
    ...
    public unsafe struct ImageCreateInfo
    {
        ...
        /// cref="SharingMode"/> is not <see cref="Catalyst.Vulkan.SharingMode.Concurrent"/>).
        /// </summary>
    ...
    public struct ImageFormatProperties
    {
        ...
        /// <summary>
        /// A bitmask of <see cref="Catalyst.Vulkan.SampleCounts"/> specifying all the supported sample
