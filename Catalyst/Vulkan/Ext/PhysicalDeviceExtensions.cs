...
namespace Catalyst.Vulkan.Ext
{
    ...
    public struct SurfaceCapabilities2Ext
    {
        ...
        /// <summary>
        /// The surface's current transform relative to the presentation Catalyst.'s natural
        ...
        /// modes supported by the presentation Catalyst. for the surface on the specified device, and
