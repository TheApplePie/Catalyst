...
using Catalyst.Vulkan.Khr;

namespace Catalyst.Vulkan.Khx
{
    /// <summary>
    ...
    public unsafe struct DeviceGroupPresentCapabilitiesKhx
    {
        ...
        /// presentation Catalyst., and where bit [j] is set in element [i] if physical device [i] can
    ...
    {
        /// <summary>
        /// Indicates that any physical device with a presentation Catalyst. can present its own
        /// swapchain images.
        /// </summary>
        Local = 1 << 0,
        /// <summary>
        /// Indicates that any physical device with a presentation Catalyst. can present swapchain
        /// images from any physical device in its present mask.
        /// </summary>
        Remote = 1 << 1,
        /// <summary>
        /// Indicates that any physical device with a presentation Catalyst. can present the sum of
        /// swapchain images from any physical devices in its present mask.
        /// </summary>
        Sum = 1 << 2,
        /// <summary>
        /// Indicates that multiple physical devices with a presentation Catalyst. can each present
